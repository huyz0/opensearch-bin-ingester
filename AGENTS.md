...
| [`brevity`](.agents/skills/brevity/SKILL.md) | When writing any reply, review report or finding. Cuts preamble, recap, tool-call narration and hedging; never the code, errors, negations or evidence inside a finding |
